>>>> Hướng dẫn chạy source code:
	1. Truy cập vào thư mục "Blog".
	2. Trong thư mục "Blog" sẽ lần lượt có 2 thư mục là: "api", "client".
	3. Truy cập lần lượt vào từng thư mục và mở cmd bằng cách gõ cmd trên đường dẫn thư mục
	5. Tại thư mục "api" và "client" gõ dòng lệnh "npm install".
...
>>>> Truy cập đường dẫn website: http://localhost:3000
